...
local Window = Rayfield:CreateWindow({
   ...
   LoadingSubtitle = "by Solehub",
   ConfigurationSaving = {
      Enabled = true,
      FolderName = nil, -- Create a custom folder for your hub/game
      FileName = "robloxkatscriptforboss"
   },
   Discord = {
      Enabled = true,
      Invite = "kkyMVtrVV3", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ABCD would be ABCD
   ...
   KeySettings = {
      ...
      Key = {"sdkqpkowkdqkopksadwqdaw"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
        ...
        while wait(0.1) do
            if (player.Character and player.Character:FindFirstChild"HumanoidRootPart") then
                ...
                if player.Character:FindFirstChild("ForceField") then
                    outlines.BackgroundTransparency = 0.5
                    ...
                    healthl.TextTransparency = 0.5
                    healthl.TextStrokeTransparency = 0.9
                    distancel.TextTransparency = 0.5
                    distancel.TextStrokeTransparency = 0.9
                    namelabel.TextTransparency = 0.5
                    namelabel.TextStrokeTransparency = 0.9
                    bar.BackgroundTransparency = 0.5
                    healthbar.BackgroundTransparency = 0.9
                else
                    outlines.BackgroundTransparency = 0.1
                    ...
                    healthl.TextTransparency = 0.1
                    healthl.TextStrokeTransparency = 0.1
                    distancel.TextTransparency = 0.1
                    distancel.TextStrokeTransparency = 0.1
                ...
                if cheats.b_f == true then
                    if player.Character:FindFirstChild("ForceField") then
                        outlines.BackgroundTransparency = 0.8
                    else
...
local SpeedTab = Window:CreateTab("✈️Fly✈️", nil) -- Title, Image
...
local Section = SpeedTab:CreateSection("Fly")
